...
const api: RiftApi = {
  ...
  writeRepositoryFile: (path, content, repositoryRoot) => ipcRenderer.invoke("repository:write-file", path, content, repositoryRoot),
  ...
  listRepositoryFiles: () => ipcRenderer.invoke("repository:list-files"),
